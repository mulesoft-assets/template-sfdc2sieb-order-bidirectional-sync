...
# Anypoint Template: Salesforce and Siebel Order Bidirectional Sync
...
# Run it! <a name="runit"/>
Simple steps to get Salesforce and Siebel Order Bidirectional Sync running.
...
Finally during the On Complete stage the Anypoint Template will logout statistics data into the console.
